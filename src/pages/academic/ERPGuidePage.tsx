      ...
      <div className="pt-20 pb-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-white mb-4">🖥️ ERP Portal Guide</h1>
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              Your complete guide to navigating the BITS ERP system
            </p>
          </div>

          <Card className="hover-scale mb-8 bg-gradient-to-r from-blue-950/25 to-purple-950/25 border border-blue-900/40 text-foreground backdrop-blur-sm shadow-xl">
            <CardHeader>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="bg-emerald-950/20 border border-emerald-900/30 p-4 rounded-lg">
                    <h4 className="font-semibold text-emerald-300 mb-2">📚 Course Management:</h4>
                    <ul className="text-sm text-slate-400 space-y-1">
                  ...
                  <div className="bg-blue-950/20 border border-blue-900/30 p-4 rounded-lg">
                    <h4 className="font-semibold text-blue-300 mb-2">📊 Academic Tracking:</h4>
                    <ul className="text-sm text-slate-400 space-y-1">
            ...
            <Card className="hover-scale bg-slate-900/40 border border-slate-800 text-foreground backdrop-blur-sm shadow-xl">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="bg-purple-950/20 border border-purple-900/30 p-4 rounded-lg">
                    <h4 className="font-semibold text-purple-300 mb-2">💳 Financial Management:</h4>
                    <ul className="text-sm text-slate-400 space-y-1">
                  ...
                  <div className="bg-amber-950/20 border border-amber-900/30 p-4 rounded-lg">
                    <h4 className="font-semibold text-amber-300 mb-2">👤 Personal Information:</h4>
                    <ul className="text-sm text-slate-400 space-y-1">
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="bg-red-950/20 border border-red-900/30 p-4 rounded-lg mb-3">
                    <Calendar className="h-8 w-8 text-red-400 mx-auto" />
                  </div>
                  <h4 className="font-semibold text-red-300 mb-2">⏰ Timing is Key</h4>
                  <ul className="text-sm text-slate-400 space-y-1">
                ...
                <div className="text-center">
                  <div className="bg-amber-950/20 border border-amber-900/30 p-4 rounded-lg mb-3">
                    <Computer className="h-8 w-8 text-amber-400 mx-auto" />
                  </div>
                  <h4 className="font-semibold text-amber-300 mb-2">🔒 Security Tips</h4>
                  <ul className="text-sm text-slate-400 space-y-1">
                ...
                <div className="text-center">
                  <div className="bg-emerald-950/20 border border-emerald-900/30 p-4 rounded-lg mb-3">
                    <GraduationCap className="h-8 w-8 text-emerald-400 mx-auto" />
                  </div>
                  <h4 className="font-semibold text-emerald-300 mb-2">📱 Stay Updated</h4>
                  <ul className="text-sm text-slate-400 space-y-1">
