    ...
    <div className="min-h-screen bg-gradient-dynamic">
      ...
      <section id="home" className="pt-24 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-800/8 rounded-full blur-3xl animate-pulse-slow" style={{animationDelay: '2s'}}></div>
        </div>

        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center justify-center mb-6 animate-bounce-in">
              <Sparkles className="h-8 w-8 text-blue-600 mr-3 animate-spin" style={{animationDuration: '3s'}} />
