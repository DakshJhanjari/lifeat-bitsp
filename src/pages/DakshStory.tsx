              ...
              <div className="text-center">
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <p className="text-lg md:text-xl text-slate-700">
                    Project Lead <span className="font-semibold text-slate-800">Inside BITS</span>
                  </p>
                </div>
                ...
                <div className="flex justify-center space-x-4 mb-8">
                  <a 
                    ...
                    className="flex items-center space-x-2 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-all duration-300 hover-lift shadow-sm"
                  >
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card className="professional-card hover-lift">
              ...
              <CardContent className="text-slate-700 leading-relaxed space-y-4">
                <p>
                  When I first got into BITS Pilani, I wasn't thrilled. Like most of us, I had spent years preparing for the IITs. Not landing there was disappointing, and it took a moment to come to terms with that. But as I read more about BITS, its culture, freedom, and alumni, it slowly sank in that I had earned a seat at <strong className="text-slate-800">one of the most respected institutes in the country</strong>. And that was something to be proud of.
                </p>
                <p>
                  I had other options at NITs, and a COMEDK rank that could've gotten me into premier private colleges like RVCE or Ramaiah. But <strong className="text-slate-800">BITS stood out</strong>. The <strong>student-driven environment</strong>, the <strong>culture of trust</strong>, and the <strong>sheer scale of opportunities</strong> made it feel like the right move. Looking back, I'd make the same choice again.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="professional-card hover-lift">
              ...
              <CardContent className="text-slate-700 leading-relaxed space-y-4">
                <p>
                  I'm pursuing a dual degree — MSc Chemistry and BE Civil. It sounds like an odd mix to some, but it's part of what makes BITS unique. This path has <strong className="text-slate-800">broadened my academic experience</strong> and <strong>challenged me to think beyond rigid silos</strong>.
                </p>
                <p>
                  That said, the start wasn't easy. I was an introvert who had never lived away from home. The thought of adjusting in a completely new environment felt overwhelming. Fitting in was hard. But I met a few seniors early on who were kind and inclusive, and with time, I started building real friendships. <strong className="text-slate-800">That made all the difference.</strong>
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="professional-card hover-lift">
              ...
              <CardContent className="text-slate-700 leading-relaxed space-y-4">
                <p>
                  My first week on campus was chaos — setting up my room, figuring out where things were, attending first lectures, and trying not to get lost on a campus that felt more like a small city. Making friends didn't happen overnight either. But <strong className="text-slate-800">I kept showing up</strong> for classes, wing meets, club orientations. That helped me slowly open up.
                </p>
                <p>
                  And then came the culture shocks — no attendance policy, making your own timetable, deciding when (and if) to attend classes. At first, it was liberating, then confusing. It took a while to learn that <strong className="text-slate-800">too much freedom with too little structure is a trap. You have to create your own systems to survive here.</strong>
                </p>
                <p>
                  Of course, there was homesickness. Everyone feels it. But soon you're up at midnight playing football, exploring the campus with your wingies, or just chilling outside, and you realize: <strong className="text-slate-800">this place has become your second home.</strong>
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="professional-card hover-lift">
              ...
              <CardContent className="text-slate-700 leading-relaxed space-y-4">
                ...
                <p>
                  Later, I contested the election for Hostel Representative of Shankar Bhawan. <strong className="text-slate-800">I lost. And it stung.</strong> After putting in time and effort, rejection can shake your confidence. There were moments I asked myself: <em>Why am I even doing this? What's the point?</em>
                </p>
                <p>
                  But <strong className="text-slate-800">quitting midway wasn't the answer</strong>. I realized that <strong>if the intent is right, the outcome doesn't define the value of your effort</strong>. I stayed in the game — continued working on student welfare projects, led several campus-wide initiatives with my peers, and kept showing up. <strong className="text-slate-800">That phase taught me more about leadership than any position ever could.</strong>
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-card shadow-lg border-2 border-slate-200">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-blue-50 p-6 rounded-xl border border-blue-200">
                  ...
                  <p className="text-2xl font-bold text-slate-700 text-center mt-4">
